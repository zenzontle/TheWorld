...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if (await _userManager.FindByEmailAsync("villo@theworld.com") == null)
            {
                //Add the user
                WorldUser newUser = new WorldUser()
                {
                    UserName = "villo",
                    Email = "villo@theworld.com"
                };

                await _userManager.CreateAsync(newUser, "Trip*wire1");
            }
            ...
            if (!_context.Trips.Any())
            {
                ...
                _context.Trips.Add(usTrip, Microsoft.Data.Entity.GraphBehavior.IncludeDependents);
                ...
                _context.Trips.Add(worldTrip, Microsoft.Data.Entity.GraphBehavior.IncludeDependents);
                _context.SaveChanges();
            }
        }
    }
